...
const q1 = new Question(
  "Türkiye'nin en fazla yağış alan ili hangisidir?",
  ["Sinop", "Zonguldak", "Rize", "Diyarbakir"],
  "Rize"
);
const q2 = new Question(
  "Gezilerini ‘Seyahatname’ adlı eserde toplayan Türk gezgin kimdir?",
  ["Evliya Сelebi", "Katip Сelebi", "Murat Gogebakan", "Candan Ercetin"],
  "Evliya Сelebi"
);
const q3 = new Question(
  "Depremin büyüklüğünü ve süresini ölçen alete ne ad verilir?",
  ["Sismograf", "Tomografi", "Topografi", "Termografi"],
  "Sismograf"
);
